...
Promise.all([
  floorMap('wood_floor_diff_1k.jpg',texture=>{texture.colorSpace=THREE.SRGBColorSpace;texture.wrapS=texture.wrapT=THREE.RepeatWrapping;texture.repeat.set(4.5,3.6);}),
  floorMap('wood_floor_nor_gl_1k.jpg',texture=>{texture.wrapS=texture.wrapT=THREE.RepeatWrapping;texture.repeat.set(4.5,3.6);}),
  floorMap('wood_floor_rough_1k.jpg',texture=>{texture.wrapS=texture.wrapT=THREE.RepeatWrapping;texture.repeat.set(4.5,3.6);})
