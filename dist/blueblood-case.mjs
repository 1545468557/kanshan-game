...
export const blueBloodCase = {
  ...
  questions: [
    { id: 'what', label: '蓝血到底是什么？', answer: '用于急救演示的蓝色模拟出血液，不是真正的人体血液。', keywords: ['模拟', '道具', '假血', '演示液', '蓝色液体'] },
    { id: 'from', label: '它从哪里来？', answer: '来自培训师教具箱里的小瓶，经假伤口贴片流到手背和地面。', keywords: ['教具', '小瓶', '瓶子', '假伤口', '贴片', '培训师'] },
    { id: 'lastNight', label: '昨晚发生了什么？', answer: '培训师布置了一场假受伤演示，故意让主角以为自己看到了真实的蓝色血液，并记录主角的反应。', keywords: ['假装', '假伤', '演示', '布置', '测试', '记录', '拍摄', '观察'] },
    { id: 'liar', label: '哪个 NPC 在撒谎？', answer: '培训师在撒谎，他明知蓝色液体是演示道具，却说那是自己的血。', keywords: ['培训师', '老师', '教练'] },
  ...
  npc: [
    { id: 'trainer', name: '培训师 · 方老师', role: '掌控演示的人', opening: '昨晚只是一次普通的急救演示。你看到的蓝色，是灯光和消毒液混在一起的颜色。', facts: ['教具箱里有蓝色模拟液和假伤口贴片。', '他提前安排了录像，并要求拍下主角第一次提出异议的反应。', '他故意把蓝色液体说成自己的血。'], lies: ['蓝色液体是真血。', '昨晚没有额外拍摄安排。'], motive: '验证主角是否会在权威解释与旁人附和下放弃自己的判断。' },
    { id: 'zhangwei', name: '同事 · 张薇', role: '看见现象的人', opening: '我确实看到了蓝色液体，但我没有看清他的手到底有没有真的破。', facts: ['她只看见液体，没有看清假伤口。', '她知道主角在聚餐时会坚持再核对一次。', '她知道培训师事前问过主角是不是“很难被说服”。'], lies: [], motive: '她不是故意撒谎，只是把看到的现象当成了自己的解释。' },
    { id: 'gray', name: '记录员 · 灰夹克', role: '负责带走教具的人', opening: '我只负责送教具和回收设备。镜头拍到了什么，你可以自己看时间轴。', facts: ['他把教具箱送到房间。', '他看见培训师要求拍摄主角的反应。', '他没有看清培训师在卫生间里如何贴上假伤口。'], lies: [], motive: '不确定培训师的全部目的，但不愿替他承担责任。' }
  ],
  props: [
...
export function scoreAnswer(question, value = '') {
  ...
  const contradiction = ['真的人体血', '真血', '自然流出', '普通清洁剂'].some(word => text.includes(word));
  if (question.id === 'liar') return /培训师|方老师|老师|教练/.test(text) ? 1 : 0;
